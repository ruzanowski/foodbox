...
{
    public abstract class FoodWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FoodWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FoodWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FoodDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FoodDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FoodDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FoodDbContext, Task<T>> func)
        {
            T result;
