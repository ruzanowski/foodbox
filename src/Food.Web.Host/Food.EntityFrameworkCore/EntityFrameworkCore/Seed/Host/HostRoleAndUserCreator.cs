...
namespace Food.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        ...
        public HostRoleAndUserCreator(FoodDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            if (adminRoleForHost == null)
            {
                ...
                _context.Roles
                    .Add(new Role(null, StaticRoleNames.Host.User, StaticRoleNames.Host.User)
                    {
                        IsStatic = true,
                        IsDefault = true
                    });
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new FoodAuthorizationProvider())
